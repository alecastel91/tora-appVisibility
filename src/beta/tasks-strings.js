...
// Beta-only strings: EN written; JA overrides land with Build Item 8. Deleted after launch.
...
// Sheet UI strings — EN default, JA override; the other six fall back to EN.
...
export const BETA_TASKS_JA = {
 ...
 T13: { title: '担当コンタクトにコネクション申請を送る。', hint: '相手のプロフィールを開き「つながる」をタップして、短いメッセージを書きます。' },
 T14: { title: 'コネクションにメッセージを送る。', hint: 'メッセージタブ、またはプロフィールのメッセージボタンから。' },
 T15: { title: 'チャットでファイルを送る。どんな添付でもOK。', hint: 'チャット入力欄のクリップアイコン。' },
 T16: { title: '担当コンタクトにオファーを送る。', hint: '相手のプロフィールかチャットを開いて「オファーを作成」。' },
