  ...
  if (profile.locked) {
    return (
      ...
      <div className="screen active view-profile-screen relative">
        {/* Same header idiom as Settings/Achievements — `sub-screen-header`
            and `back-btn` are not defined anywhere and rendered unstyled. */}
        <div className="settings-header">
          <button type="button" className="back-button" onClick={onClose} aria-label={t('common.back')}>
